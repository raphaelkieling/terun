...
var PluginManager = /** @class */ (function () {
    ...
    PluginManager.prototype.configure = function (config) {
    ...
    PluginManager.prototype.onInit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _i, _a, plugin;
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    PluginManager.prototype.onTransport = function (transport) {
        return __awaiter(this, void 0, void 0, function () {
            var _i, _a, plugin;
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    PluginManager.prototype.beforeRender = function (localArgs) {
        return __awaiter(this, void 0, void 0, function () {
            var renderData, _i, _a, plugin, _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        renderData = localArgs;
                        _i = 0, _a = this.plugins;
                        _e.label = 1;
                    case 1:
                        if (!(_i < _a.length)) return [3 /*break*/, 4];
                    ...
                    case 3:
                        _i++;
                        return [3 /*break*/, 1];
                    case 4: return [2 /*return*/, renderData];
                }
            });
        });
    };
    PluginManager.prototype.done = function () {
        return __awaiter(this, void 0, void 0, function () {
            var done, _i, _a, plugin;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        done = true;
